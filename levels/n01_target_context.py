...
def run(cfg, report):
    ...
    elif cfg.get("semantik"):
        report.add("target.layout.external_profile", "PASS", "target", "The SemantiK Architect profile is intentionally diagnosing an external target repository.", evidence={"tool_root":str(tool),"target_root":str(target)})
    else:
